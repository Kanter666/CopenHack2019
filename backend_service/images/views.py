...
def post_image(request: Request):
    ...
    face_detect_data = test_detect_res(request.data['data'])
    data = {
        'slouch': i > 0,  # comes from posture module
        'smile': face_detect_data['smile'],
        'emotion': face_detect_data['emotion'],
        'focus': i == 0  # comes from face rectangle
    }
...
def test_detect_res(image_url1):
        ...
        response = requests.post(face_api_url, params=params, headers=headers, json={"url": image_url1})
